...
class PathsTest(unittest.TestCase):
    ...
    def test_override_wins(self):
        tmp = os.path.join(os.environ.get("TEMP", "/tmp"), "celina_test_home")
    ...
    def test_workspace_dir_is_created_under_data_dir(self):
        tmp = os.path.join(os.environ.get("TEMP", "/tmp"), "celina_test_home2")
        os.environ["CELINA_HOME"] = tmp
    ...
    def test_env_file_under_data_dir(self):
        tmp = os.path.join(os.environ.get("TEMP", "/tmp"), "celina_test_home3")
        os.environ["CELINA_HOME"] = tmp
        self.assertEqual(
